...
#property description "Test EA for TrendFollowing, Breakout, and MeanReversion Strategies"
...
int OnInit() {
    Print("========================================");
    Print("TestThreeStrategies EA - Initializing");
    Print("========================================");
    ...
    Print("========================================");
    Print("All 3 strategies ready - Waiting for bars...");
    Print("========================================");
...
void OnDeinit(const int reason) {
    Print("========================================");
    Print("TestThreeStrategies EA - Shutting down");
...
void OnTick() {
    ...
    if(InpShowMarket) {
        ...
        Print("  Price: ", DoubleToString(state.bid, 2),
              " | BB Upper: ", DoubleToString(state.bbUpper, 2),
              " | BB Lower: ", DoubleToString(state.bbLower, 2));
    ...
    if(activeCount >= 2) {
        ...
        Print("  Active strategies: ", activeCount, "/3");
