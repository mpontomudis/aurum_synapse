                                            ...
                                            string &html)
{
   ...
   GovRuntimeVisualHtmlW1_AppendLf(html, "<p>Report index slot reserved. Filename pattern: <code>" + GovRuntimeVisualHtmlW1_Escape(GOV_VISUAL_REPORT_PREFIX_V1) + "YYYYMMDD_HHMMSS" +
                                         GovRuntimeVisualHtmlW1_Escape(GOV_VISUAL_HTML_EXT_V1) + "</code></p>\n");
