...
| **Join-validation golden harness** | Strategy Tester / `OnInit` — `Tests/TestTelemetryJoinValidation.mq5` after copying `Experts/AurumSynapse/TelemetryFixtures/` → Common (`Case_001`–`Case_003` **PASS** as of **2026-05-10**; see `TelemetryAnalytics/PHASE_3B_GOLDEN_FIXTURE_VALIDATION.md`) |
